...
![Pride full video](./android_pride_full_ex.gif)
...
We tried first with separate line segments to represent the rainbow: ![pride rainbow first
...
![geometry setup](./geometry_opengl_rainbow_box.png)
